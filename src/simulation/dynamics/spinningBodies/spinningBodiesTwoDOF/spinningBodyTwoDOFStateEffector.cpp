...
SpinningBodyTwoDOFStateEffector::~SpinningBodyTwoDOFStateEffector()
{
    ...
    for (auto & spinningBodyConfigLogOutMsg : this->spinningBodyConfigLogOutMsgs) {
        free(spinningBodyConfigLogOutMsg);
    }
    for (auto & spinningBodyOutMsg : this->spinningBodyOutMsgs) {
        free(spinningBodyOutMsg);
    }

    SpinningBodyTwoDOFStateEffector::effectorID = 1;    /* reset the panel ID*/
}
